  ...
  return (
    <main>
      ...
      <section id="section-1">
        ...
        >
          <div className="absolute inset-x-0 top-0 w-full h-screen max-h-full bg-contain bg-center bg-no-repeat md:hidden" style={{ backgroundImage: "url(/img/BG-SiteAnim-PlanterModel-Phase1-v9-frame_DeMain_m.jpg)" }}></div>
      ...
      >
        ...
        <div className="foreground relative z-40 w-full">
          ...
          <div className="relative py-20 md:mb-40">
            <div className="absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat md:hidden" style={{ backgroundImage: "url(/img/Phase4-v9-frame_DeMain_m.jpg)" }}></div>
