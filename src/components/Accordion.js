...
const Accordion = ({ accordionItem }) => {
  ...
  return (
    <li className="border-b border-slate overflow-hidden">
      ...
      >
        <span className="bg-animate bg-animate-electric-lime md:hover:text-not-dark-blue">
          <span className="relative">
            {accordionItem.heading}
          </span>
        </span>
        <button className="absolute right-0 top-1/2 transform -translate-y-1/2 text-cream border border-slate rounded-full bg-animate bg-animate-electric-lime md:hover:border-not-dark-blue md:hover:text-not-dark-blue">
