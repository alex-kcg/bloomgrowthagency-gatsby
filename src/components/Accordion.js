      ...
      >
        ...
        <button className="absolute right-0 top-1/2 transform -translate-y-1/2 text-cream border border-slate rounded-full bg-animate bg-animate-electric-lime hover:border-not-dark-blue hover:text-not-dark-blue">
          <svg className="relative h-10 w-10" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path className={`fill-current ${expanded ? '' : 'hidden'}`} fill-rule="evenodd" clip-rule="evenodd" d="M26 19.5C26 19.7761 25.6162 20 25.1429 20L14.8571 20C14.3838 20 14 19.7761 14 19.5C14 19.2239 14.3838 19 14.8571 19L25.1429 19C25.6162 19 26 19.2239 26 19.5Z" />
          </svg>
        </button>
      </motion.h3>
...
Accordion.propTypes = {
  accordionItem: PropTypes.arrayOf(
    PropTypes.shape({
